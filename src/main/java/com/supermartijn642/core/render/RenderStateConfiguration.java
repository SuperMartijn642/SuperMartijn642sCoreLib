        ...
        public Builder useTexture(ResourceLocation texture, boolean useBlur, boolean useMipmap){
            this.textureState = new RenderStateEntry(null, null) {
                ...
                public void setup(){
                    ...
                    GlStateManager.enableTexture2D();
                    ClientUtils.getTextureManager().bindTexture(texture);
                    ClientUtils.getTextureManager().getTexture(texture).setBlurMipmap(useBlur, useMipmap);
                }
                ...
                public void clear(){
                    if(!this.enableTextures)
                        GlStateManager.disableTexture2D();
                    ClientUtils.getTextureManager().getTexture(texture).restoreLastBlurMipmap();
                }
            };
            return this;
        }
        ...
        public Builder disableLightmap(){
            this.lightmapState = new RenderStateEntry(null, null) {
                ...
                public void setup(){
                    ...
                    ClientUtils.getMinecraft().entityRenderer.disableLightmap();
                }

                @Override
                public void clear(){
                    if(this.enableLightmap)
                        ClientUtils.getMinecraft().entityRenderer.enableLightmap();
                }
            };
            return this;
        }
...
//            this.overlayState = new RenderStateEntry(() -> ClientUtils.getMinecraft().gameRenderer.overlayTexture().setupOverlayColor(), () -> ClientUtils.getMinecraft().gameRenderer.overlayTexture().teardownOverlayColor());
        ...
        public Builder useDefaultLineWidth(){
            this.lineWidthState = new RenderStateEntry(() -> GlStateManager.glLineWidth(1), null);
            return this;
        }

        public Builder useLineWidth(float width){
            this.lineWidthState = new RenderStateEntry(() -> GlStateManager.glLineWidth(width), () -> GlStateManager.glLineWidth(1));
            return this;
        }

        public Builder useWindowRelativeLineWidth(){
            this.lineWidthState = new RenderStateEntry(() -> GlStateManager.glLineWidth(Math.max(2.5F, ClientUtils.getMinecraft().displayWidth / 1920f * 2.5f)), () -> GlStateManager.glLineWidth(1));
            return this;
        }
