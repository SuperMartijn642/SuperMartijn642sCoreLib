...
public interface CustomSlot {
    ...
    interface Builder {
        ...
        default Builder itemHandler(Supplier<ResourceHandler<ItemResource>> handlerSupplier){
            return this.itemHandler(0, handlerSupplier);
        }

        Builder itemHandler(int index, Supplier<ResourceHandler<ItemResource>> handlerSupplier);
