...
public class CursorTypes {
    ...
    private static final CursorType POINTING_HAND = new CursorType(GLFW.GLFW_POINTING_HAND_CURSOR);
    private static final CursorType RESIZE_VERTICAL = new CursorType(GLFW.GLFW_RESIZE_NS_CURSOR);
    private static final CursorType RESIZE_HORIZONTAL = new CursorType(GLFW.GLFW_RESIZE_EW_CURSOR);
    private static final CursorType RESIZE_ALL = new CursorType(GLFW.GLFW_RESIZE_ALL_CURSOR);
    private static final CursorType NOT_ALLOWED = new CursorType(GLFW.GLFW_NOT_ALLOWED_CURSOR);
