 ...
 */
public final class BaseContainerType<T extends AbstractContainerMenu> extends ExtendedScreenHandlerType<T> {
    ...
    private BaseContainerType(BiConsumer<T,FriendlyByteBuf> containerSerializer, TriFunction<Integer,Player,FriendlyByteBuf,T> containerDeserializer){
        super((id, inventory, data) -> containerDeserializer.apply(id, inventory.player, data));
