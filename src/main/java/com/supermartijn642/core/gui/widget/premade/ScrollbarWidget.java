...
public class ScrollbarWidget extends BaseWidget {
    ...
    @ApiStatus.Internal
    public static final ResourceLocation BACKGROUND = ResourceLocation.fromNamespaceAndPath("supermartijn642corelib", "gui/scrollbar_background");
    @ApiStatus.Internal
    public static final ResourceLocation SCROLLER = ResourceLocation.fromNamespaceAndPath("supermartijn642corelib", "gui/scroller");
