...
public class ScrollbarWidget extends BaseWidget {
    ...
    public void render(int mouseX, int mouseY){
        ...
        if(range <= 0 || !this.active){
            ...
            ScreenUtils.drawTexture(this.x, this.y, this.width, this.scrollerHeight, 0, 2 / 3f, 1, 1 / 3f);
            return;
        }
        ...
        ScreenUtils.bindTexture(this.scroller);
        ScreenUtils.drawTexture(this.x, this.y + offset, this.width, this.scrollerHeight, 0, this.scrollable && this.isFocused() ? 1 / 3f : 0, 1, 1 / 3f);
    }
