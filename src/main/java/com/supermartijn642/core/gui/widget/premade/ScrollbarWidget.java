...
public class ScrollbarWidget extends BaseWidget {
    ...
    @ApiStatus.Internal
    public static final ResourceLocation BACKGROUND = ResourceLocation.fromNamespaceAndPath("supermartijn642corelib", "textures/gui/scrollbar_background.png");
    @ApiStatus.Internal
    public static final ResourceLocation SCROLLER = ResourceLocation.fromNamespaceAndPath("supermartijn642corelib", "textures/gui/scroller.png");
    ...
    public void renderBackground(WidgetRenderContext context, int mouseX, int mouseY){
        ...
        if(this.background != null)
            ScreenUtils.drawTexture(this.background, context.poseStack(), this.x - 1, this.y - 1, this.width + 2, this.height + 2);
    }
    ...
    public void render(WidgetRenderContext context, int mouseX, int mouseY){
        ...
        if(range <= 0 || !this.active){
            ScreenUtils.drawTexture(this.scroller, context.poseStack(), this.x, this.y, this.width, this.scrollerHeight, 0, 2 / 3f, 1, 1 / 3f);
            return;
        }
        ...
        ScreenUtils.drawTexture(this.scroller, context.poseStack(), this.x, this.y + offset, this.width, this.scrollerHeight, 0, this.scrollable && this.isFocused() ? 1 / 3f : 0, 1, 1 / 3f);
    }
