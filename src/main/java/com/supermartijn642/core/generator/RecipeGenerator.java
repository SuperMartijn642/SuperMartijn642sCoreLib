...
public abstract class RecipeGenerator extends ResourceGenerator {
    ...
    public void save(){
        ...
        for(RecipeBuilder<?> recipeBuilder : this.recipes.values()){
            ...
            if(recipeBuilder instanceof ShapedRecipeBuilder){
                ...
                json.addProperty("group", recipeBuilder.group);
                // Base
                json.add("base", ((IngredientExtension)((SmithingRecipeBuilder)recipeBuilder).base).coreLibSerialize());
                // Addition
                json.add("addition", ((IngredientExtension)((SmithingRecipeBuilder)recipeBuilder).addition).coreLibSerialize());
                // Result
                JsonObject resultJson = new JsonObject();
                resultJson.addProperty("item", Registries.ITEMS.getIdentifier(recipeBuilder.output).toString());
                if(recipeBuilder.output.getHasSubtypes() || (recipeBuilder.output.isDamageable() && recipeBuilder.outputData >= 0))
     ...
     * @param amount         count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(ResourceLocation recipeLocation, Item output, int data, NBTTagCompound nbt, int amount){
        return this.recipe(recipeLocation, new SmithingRecipeBuilder(recipeLocation, output, data, nbt, amount));
    }
     ...
     * @param amount         count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(ResourceLocation recipeLocation, Item output, NBTTagCompound nbt, int amount){
        return this.smithing(recipeLocation, output, -1, nbt, amount);
    }
     ...
     * @param amount     count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(String namespace, String identifier, Item output, int data, NBTTagCompound nbt, int amount){
        return this.smithing(new ResourceLocation(namespace, identifier), output, data, nbt, amount);
    }
     ...
     * @param amount     count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(String namespace, String identifier, Item output, NBTTagCompound nbt, int amount){
     ...
     * @param amount     count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(String identifier, Item output, int data, NBTTagCompound nbt, int amount){
        return this.smithing(this.modid, identifier, output, data, nbt, amount);
    }
     ...
     * @param amount     count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(String identifier, Item output, NBTTagCompound nbt, int amount){
     ...
     * @param amount count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(Item output, int data, NBTTagCompound nbt, int amount){
        ResourceLocation identifier = Registries.ITEMS.getIdentifier(output);
        return this.smithing(identifier, output, data, nbt, amount);
    }
     ...
     * @param amount count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(Item output, NBTTagCompound nbt, int amount){
        ResourceLocation identifier = Registries.ITEMS.getIdentifier(output);
     ...
     * @param amount         count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(ResourceLocation recipeLocation, Item output, int data, int amount){
        return this.smithing(recipeLocation, output, data, null, amount);
    }
     ...
     * @param amount         count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(ResourceLocation recipeLocation, Item output, int amount){
     ...
     * @param amount     count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(String namespace, String identifier, Item output, int data, int amount){
        return this.smithing(new ResourceLocation(namespace, identifier), output, data, null, amount);
    }
     ...
     * @param amount     count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(String namespace, String identifier, Item output, int amount){
     ...
     * @param amount     count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(String identifier, Item output, int data, int amount){
        return this.smithing(this.modid, identifier, output, data, null, amount);
    }
     ...
     * @param amount     count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(String identifier, Item output, int amount){
     ...
     * @param amount count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(Item output, int data, int amount){
        return this.smithing(output, data, null, amount);
    }
     ...
     * @param amount count of the recipe result
     */
    protected SmithingRecipeBuilder smithing(Item output, int amount){
     ...
     * @param output         recipe result
     */
    protected SmithingRecipeBuilder smithing(ResourceLocation recipeLocation, Item output){
     ...
     * @param output     recipe result
     */
    protected SmithingRecipeBuilder smithing(String namespace, String identifier, Item output){
     ...
     * @param output     recipe result
     */
    protected SmithingRecipeBuilder smithing(String identifier, Item output){
     ...
     * @param output recipe result
     */
    protected SmithingRecipeBuilder smithing(Item output){
    ...
    protected SmithingRecipeBuilder smithing(ResourceLocation recipeLocation, ItemStack output){
        return this.smithing(recipeLocation, output.getItem(), output.getHasSubtypes() ? output.getMetadata() : -1, output.hasTagCompound() && !output.getTagCompound().hasNoTags() ? output.getTagCompound() : null, output.getCount());
    }
    ...
    protected SmithingRecipeBuilder smithing(String namespace, String identifier, ItemStack output){
        return this.smithing(new ResourceLocation(namespace, identifier), output.getItem(), output.getHasSubtypes() ? output.getMetadata() : -1, output.hasTagCompound() && !output.getTagCompound().hasNoTags() ? output.getTagCompound() : null, output.getCount());
    }
    ...
    protected SmithingRecipeBuilder smithing(String identifier, ItemStack output){
        return this.smithing(this.modid, identifier, output.getItem(), output.getHasSubtypes() ? output.getMetadata() : -1, output.hasTagCompound() && !output.getTagCompound().hasNoTags() ? output.getTagCompound() : null, output.getCount());
    }
    ...
    protected SmithingRecipeBuilder smithing(ItemStack output){
        return this.smithing(output.getItem(), output.getHasSubtypes() ? output.getMetadata() : -1, output.hasTagCompound() && !output.getTagCompound().hasNoTags() ? output.getTagCompound() : null, output.getCount());
    }
    ...
    protected static class ShapedRecipeBuilder extends RecipeBuilder<ShapedRecipeBuilder> {
        ...
        private ShapedRecipeBuilder(ResourceLocation identifier, Item output, int outputData, NBTTagCompound outputTag, int outputCount){
            super(identifier, output, outputData, outputTag, outputCount);
        }
    ...
    protected static class SmeltingRecipeBuilder extends RecipeBuilder<SmeltingRecipeBuilder> {
        ...
        private SmeltingRecipeBuilder(ResourceLocation identifier, Item output, int outputData, NBTTagCompound outputTag, int count){
            super(identifier, output, outputData, outputTag, count);
        }
    ...
    protected static class SmithingRecipeBuilder extends RecipeBuilder<SmithingRecipeBuilder> {
        ...
        private SmithingRecipeBuilder(ResourceLocation identifier, Item output, int outputData, NBTTagCompound outputTag, int outputCount){
            super(identifier, output, outputData, outputTag, outputCount);
        }
         ...
         */
        public SmithingRecipeBuilder base(Item... items){
            return this.base(Ingredient.fromItems(items));
        }
        ...
        public SmithingRecipeBuilder base(ItemStack... itemStacks){
            return this.base(Ingredient.fromStacks(itemStacks));
        }

        /**
         * Sets the base ingredient for this recipe.
         * @param oreDict ore dictionary tag to be accepted as base
         */
        public SmithingRecipeBuilder base(String oreDict){
            return this.base(new OreIngredient(oreDict));
        }
         ...
         */
        public SmithingRecipeBuilder addition(Item... items){
            return this.addition(Ingredient.fromItems(items));
        }
        ...
        public SmithingRecipeBuilder addition(ItemStack... itemStacks){
            return this.addition(Ingredient.fromStacks(itemStacks));
        }

        /**
         * Sets the addition ingredient for this recipe.
         * @param oreDict ore dictionary tag to be accepted as addition
         */
        public SmithingRecipeBuilder addition(String oreDict){
            return this.addition(new OreIngredient(oreDict));
        }
    }
    ...
    protected static class StoneCuttingRecipeBuilder extends RecipeBuilder<StoneCuttingRecipeBuilder> {
        ...
        private StoneCuttingRecipeBuilder(ResourceLocation identifier, Item output, int outputData, int outputCount){
            super(identifier, output, outputData, null, outputCount);
        }
